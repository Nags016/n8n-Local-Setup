...
print_header "n8n Installation Script for Arch-based Linux"
...
print_header "Step 4: Verifying Docker Installation"
...
print_header "Step 5: Setting up n8n Directory"
N8N_DIR="$HOME/.n8n"
if [ -d "$N8N_DIR" ]; then
...
EOF
    ...
    print_warning "⚠️  IMPORTANT: Change the password in docker-compose.yml!"
    print_info "Edit the file: nano $N8N_DIR/docker-compose.yml"
fi

# Pull Docker image
print_header "Step 7: Downloading n8n Docker Image"
...
print_header "Step 9: Setting up Auto-start (Optional)"
...
echo -e "  2. Change the default password in docker-compose.yml"
echo -e "  3. Restart n8n: cd ~/.n8n && docker-compose restart"
echo -e "  4. Read the documentation at https://docs.n8n.io\n"
echo -e "${GREEN}Happy automating! 🚀${NC}\n"

# Check if group change requires re-login
